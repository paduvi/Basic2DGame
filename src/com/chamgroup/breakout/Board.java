...
public class Board extends JPanel implements Commons {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2064447506294775702L;
	Image ii;
	Timer timer;
	...
	public void gameInit() {
		...
		for (int i = 0; i < 5; i++) {
			for (int j = 0; j < 6; j++) {
				bricks[k] = new Brick(j * 40 + 30, i * 15 + 50);
				k++;
			}
		}
	}
	...
	public void checkCollision() {
		...
		if ((ball.getRect()).intersects(paddle.getRect())) {
			...
			int first = paddleLPos + 9;
			int second = paddleLPos + 18;
			int third = paddleLPos + 22;
			int fourth = paddleLPos + 31;
